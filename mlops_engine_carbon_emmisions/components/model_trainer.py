...
from mlops_engine_carbon_emmisions.utils.main_utils import load_numpy_array_data, read_yaml_file, load_object, save_object
from mlops_engine_carbon_emmisions.entity.config_entity import ModelTrainerConfig
from mlops_engine_carbon_emmisions.entity.artifact_entity import DataTransformationArtifact, ModelTrainerArtifact, ClassificationMetricArtifact
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        try:
            ...
            my_model = MyModel(preprocessing_object=preprocessing_obj,
            ...
            raise ModelFactory(e, sys) from e